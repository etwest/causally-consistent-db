...
docker run -d -p 8080:8080 --net=mynet -e IP_PORT="10.0.0.10:8080" -e VIEW=$VIEW -e S="1" --ip=10.0.0.10 hw4
docker run -d -p 8081:8080 --net=mynet -e IP_PORT="10.0.0.11:8080" -e VIEW=$VIEW -e S="1" --ip=10.0.0.11 hw4
docker run -d -p 8082:8080 --net=mynet -e IP_PORT="10.0.0.12:8080" -e VIEW=$VIEW -e S="1" --ip=10.0.0.12 hw4
